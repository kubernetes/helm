...
func addInstallFlags(cmd *cobra.Command, f *pflag.FlagSet, client *action.Install, valueOpts *values.Options) {
	...
	f.BoolVar(&client.WithLineNumbers, "with-line-numbers", false, "if set, if the templating encouters errors, add line numbers to the rendered resources for debugging (should be used with --debug)")
