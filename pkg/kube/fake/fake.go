...
func (f *FailingKubeClient) Update(r, modified kube.ResourceList, ignoreMe bool, _ time.Duration) (*kube.Result, error) {
	if f.UpdateError != nil {
		return &kube.Result{}, f.UpdateError
	}
	return f.PrintingKubeClient.Update(r, modified, ignoreMe, 0)
}
